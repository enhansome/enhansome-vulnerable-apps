...
* [Vulhub](https://github.com/vulhub/vulhub) ⭐ 21,122 | 🐛 50 | 🌐 Dockerfile | 📅 2026-07-22
...
* [Kubernetes Goat](https://github.com/madhuakula/kubernetes-goat) ⭐ 5,747 | 🐛 28 | 🌐 HTML | 📅 2026-04-16 - Kubernetes Goat is "Vulnerable by Design" Kubernetes Cluster. Designed to be an intentionally vulnerable cluster environment to learn and practice Kubernetes security.
...
* [Owasp Juice shop](https://github.com/juice-shop/juice-shop) ⭐ 13,672 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-10 - OWASP Juice Shop: Probably the most modern and sophisticated insecure web application
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,499 | 🐛 7 | 🌐 PHP | 📅 2026-08-07 - Damn Vulnerable Web Application (DVWA)
...
* [VAmPI](https://github.com/erev0s/VAmPI) ⭐ 1,305 | 🐛 4 | 🌐 Python | 📅 2026-04-07 - Vulnerable REST API with OWASP top 10 vulnerabilities for security testing
...
* [Owasp VulnerableApp](https://github.com/SasanLabs/VulnerableApp) ⭐ 455 | 🐛 115 | 🌐 Java | 📅 2026-08-16 - A modular deliberately vulnerable application designed primarily for validating and benchmarking security scanners through reproducible test scenarios, while also supporting learning and experimentation.
...
* [OSS – OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 34 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-16 - An intentionally vulnerable e-commerce application built with Next.js and React. A self-hosted CTF platform for web security training covering OWASP Top 10 vulnerabilities.
...
* [Vulhub](https://github.com/vulhub/vulhub) ⭐ 21,122 | 🐛 50 | 🌐 Dockerfile | 📅 2026-07-22 - Vulhub is an open-source collection of pre-built vulnerable docker environments.
* [CI/CD Goat](https://github.com/cider-security-research/cicd-goat) ⭐ 2,287 | 🐛 0 | 🌐 Python | 📅 2024-07-14 - Deliberately vulnerable CI/CD environment. Hack CI/CD pipelines, catch the flags.
