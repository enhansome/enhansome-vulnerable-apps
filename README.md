...
* [Kubernetes Goat](https://github.com/madhuakula/kubernetes-goat) ⭐ 5,744 | 🐛 28 | 🌐 HTML | 📅 2026-04-16 - Kubernetes Goat is "Vulnerable by Design" Kubernetes Cluster. Designed to be an intentionally vulnerable cluster environment to learn and practice Kubernetes security.
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,692 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - CloudGoat is Rhino Security Labs' "Vulnerable by Design" AWS deployment tool
...
* [AndroGoat](https://github.com/satishpatnayak/AndroGoat) ⭐ 386 | 🐛 2 | 🌐 Kotlin | 📅 2025-11-22 - AndroGoat is purposely developed open source vulnerable/insecure app using Kotlin.
...
* [Owasp VulnerableApp](https://github.com/SasanLabs/VulnerableApp) ⭐ 448 | 🐛 92 | 🌐 Java | 📅 2026-08-13 - A modular deliberately vulnerable application designed primarily for validating and benchmarking security scanners through reproducible test scenarios, while also supporting learning and experimentation.
...
* [OSS – OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 34 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-11 - An intentionally vulnerable e-commerce application built with Next.js and React. A self-hosted CTF platform for web security training covering OWASP Top 10 vulnerabilities.
...
* [SSRF\_Vulnerable\_Lab](https://github.com/incredibleindishell/SSRF_Vulnerable_Lab) ⭐ 789 | 🐛 3 | 🌐 PHP | 📅 2023-08-21 - This Lab contain the sample codes which are vulnerable to Server-Side Request Forgery attack
