...
* [Vulhub](https://github.com/vulhub/vulhub) ⭐ 21,241 | 🐛 55 | 🌐 Dockerfile | 📅 2026-09-15
...
* [Kubernetes Goat](https://github.com/madhuakula/kubernetes-goat) ⭐ 5,784 | 🐛 28 | 🌐 HTML | 📅 2026-04-16 - Kubernetes Goat is "Vulnerable by Design" Kubernetes Cluster. Designed to be an intentionally vulnerable cluster environment to learn and practice Kubernetes security.
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,729 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - CloudGoat is Rhino Security Labs' "Vulnerable by Design" AWS deployment tool
* [AWSGoat](https://github.com/ine-labs/AWSGoat) ⭐ 2,047 | 🐛 12 | 🌐 PHP | 📅 2025-05-20 - A Damn Vulnerable AWS Infrastructure
* [TerraGoat - Vulnerable Terraform Infra](https://github.com/bridgecrewio/terragoat) ⭐ 1,304 | 🐛 62 | 🌐 HCL | 📅 2025-07-13 - TerraGoat is Bridgecrew's "Vulnerable by Design" Terraform repository.
...
* [Owasp Juice shop](https://github.com/juice-shop/juice-shop) ⭐ 13,877 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-14 - OWASP Juice Shop: Probably the most modern and sophisticated insecure web application
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,673 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - Damn Vulnerable Web Application (DVWA)
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,339 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-14 - WebGoat is a deliberately insecure application by OWASP for training purpose
...
* [crApi](https://github.com/OWASP/crAPI) ⭐ 1,582 | 🐛 30 | 🌐 Java | 📅 2026-09-09 - completely ridiculous API: crAPI will help you to understand the ten most critical API security risks. crAPI is vulnerable by design, but you'll be able to safely run it to educate/train yourself.
* [OWASP Mutillidae II](https://github.com/webpwnized/mutillidae) ⭐ 1,521 | 🐛 1 | 🌐 PHP | 📅 2026-06-22 - OWASP Mutillidae II is a free, open source, deliberately vulnerable web-application providing a target for web-security enthusiast.
...
* [Owasp VulnerableApp](https://github.com/SasanLabs/VulnerableApp) ⭐ 461 | 🐛 104 | 🌐 Java | 📅 2026-09-16 - A modular deliberately vulnerable application designed primarily for validating and benchmarking security scanners through reproducible test scenarios, while also supporting learning and experimentation.
...
* [The Most Vulnerable .NET App](https://github.com/AlexGoOn/the-most-vulnerable-dotnet-app) ⭐ 525 | 🐛 0 | 🌐 HTML | 📅 2026-03-06 - Interactive educational project that demonstrates common security vulnerabilities in .NET applications
...
* [OWASP IoT Goat](https://github.com/OWASP/IoTGoat) ⭐ 934 | 🐛 2 | 🌐 C | 📅 2025-10-05 - IoTGoat is a deliberately insecure firmware created to educate software developers and security professionals with testing commonly found vulnerabilities in IoT devices.
...
* [Vulhub](https://github.com/vulhub/vulhub) ⭐ 21,241 | 🐛 55 | 🌐 Dockerfile | 📅 2026-09-15 - Vulhub is an open-source collection of pre-built vulnerable docker environments.
