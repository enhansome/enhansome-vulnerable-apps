...
* [Metasploitable3](https://github.com/rapid7/metasploitable3) ⭐ 5,702 | 🐛 75 | 🌐 HTML | 📅 2025-02-13 - Metasploitable3 is a VM that is built from the ground up with a large amount of security vulnerabilities.
* [Exploit Exercises](https://exploit-exercises.lains.space/)
* [Hackmyvm.eu](https://hackmyvm.eu/)

## Cloud Security

* [Kubernetes Goat](https://github.com/madhuakula/kubernetes-goat) ⭐ 5,773 | 🐛 28 | 🌐 HTML | 📅 2026-04-16 - Kubernetes Goat is "Vulnerable by Design" Kubernetes Cluster. Designed to be an intentionally vulnerable cluster environment to learn and practice Kubernetes security.
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,722 | 🐛 24 | 🌐 Python | 📅 2026-04-28 - CloudGoat is Rhino Security Labs' "Vulnerable by Design" AWS deployment tool
...
* [AzureGoat](https://github.com/ine-labs/AzureGoat) ⭐ 964 | 🐛 6 | 🌐 Python | 📅 2024-10-30 - A Damn Vulnerable Azure Infrastructure
...
* [DIVA Android](https://github.com/payatu/diva-android) ⭐ 1,142 | 🐛 13 | 🌐 Java | 📅 2023-05-19 - Damn Insecure and vulnerable App for Android.
...
* [OVAA](https://github.com/oversecured/ovaa) ⭐ 757 | 🐛 1 | 🌐 Java | 📅 2024-07-18 - Oversecured Vulnerable Android App.
* [Allsafe](https://github.com/t0thkr1s/allsafe) ⭐ 425 | 🐛 2 | 🌐 Java | 📅 2025-09-20 - Allsafe is an intentionally vulnerable application that contains various vulnerabilities.
* [AndroGoat](https://github.com/satishpatnayak/AndroGoat) ⭐ 394 | 🐛 2 | 🌐 Kotlin | 📅 2025-11-22 - AndroGoat is purposely developed open source vulnerable/insecure app using Kotlin.
...
* [Owasp Juice shop](https://github.com/juice-shop/juice-shop) ⭐ 13,834 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-09 - OWASP Juice Shop: Probably the most modern and sophisticated insecure web application
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,638 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - Damn Vulnerable Web Application (DVWA)
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,329 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-10 - WebGoat is a deliberately insecure application by OWASP for training purpose
...
* [crApi](https://github.com/OWASP/crAPI) ⭐ 1,575 | 🐛 30 | 🌐 Java | 📅 2026-09-09 - completely ridiculous API: crAPI will help you to understand the ten most critical API security risks. crAPI is vulnerable by design, but you'll be able to safely run it to educate/train yourself.
* [OWASP Mutillidae II](https://github.com/webpwnized/mutillidae) ⭐ 1,515 | 🐛 1 | 🌐 PHP | 📅 2026-06-22 - OWASP Mutillidae II is a free, open source, deliberately vulnerable web-application providing a target for web-security enthusiast.
* [VAmPI](https://github.com/erev0s/VAmPI) ⭐ 1,321 | 🐛 4 | 🌐 Python | 📅 2026-04-07 - Vulnerable REST API with OWASP top 10 vulnerabilities for security testing
...
* [Owasp VulnerableApp](https://github.com/SasanLabs/VulnerableApp) ⭐ 461 | 🐛 109 | 🌐 Java | 📅 2026-09-10 - A modular deliberately vulnerable application designed primarily for validating and benchmarking security scanners through reproducible test scenarios, while also supporting learning and experimentation.
...
* [OSS – OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 43 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-09 - An intentionally vulnerable e-commerce application built with Next.js and React. A self-hosted CTF platform for web security training covering OWASP Top 10 vulnerabilities.
...
* [OWASP IoT Goat](https://github.com/OWASP/IoTGoat) ⭐ 931 | 🐛 2 | 🌐 C | 📅 2025-10-05 - IoTGoat is a deliberately insecure firmware created to educate software developers and security professionals with testing commonly found vulnerabilities in IoT devices.
...
* [Vulhub](https://github.com/vulhub/vulhub) ⭐ 21,228 | 🐛 53 | 🌐 Dockerfile | 📅 2026-07-22 - Vulhub is an open-source collection of pre-built vulnerable docker environments.
* [CI/CD Goat](https://github.com/cider-security-research/cicd-goat) ⭐ 2,302 | 🐛 0 | 🌐 Python | 📅 2024-07-14 - Deliberately vulnerable CI/CD environment. Hack CI/CD pipelines, catch the flags.
