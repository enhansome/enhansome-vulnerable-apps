...
* [Kubernetes Goat](https://github.com/madhuakula/kubernetes-goat) ⭐ 5,745 | 🐛 28 | 🌐 HTML | 📅 2026-04-16 - Kubernetes Goat is "Vulnerable by Design" Kubernetes Cluster. Designed to be an intentionally vulnerable cluster environment to learn and practice Kubernetes security.
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,693 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - CloudGoat is Rhino Security Labs' "Vulnerable by Design" AWS deployment tool
* [AWSGoat](https://github.com/ine-labs/AWSGoat) ⭐ 2,041 | 🐛 12 | 🌐 PHP | 📅 2025-05-20 - A Damn Vulnerable AWS Infrastructure
* [TerraGoat - Vulnerable Terraform Infra](https://github.com/bridgecrewio/terragoat) ⭐ 1,304 | 🐛 60 | 🌐 HCL | 📅 2025-07-13 - TerraGoat is Bridgecrew's "Vulnerable by Design" Terraform repository.
...
* [IAM Vulnerable](https://github.com/BishopFox/iam-vulnerable) ⭐ 585 | 🐛 0 | 🌐 HCL | 📅 2026-03-12 - Use Terraform to create your own vulnerable by design AWS IAM privilege escalation playground.
...
* [InsecureBankv2](https://github.com/dineshshetty/Android-InsecureBankv2) ⭐ 1,465 | 🐛 17 | 🌐 Java | 📅 2024-04-17 - Vulnerable Android application for developers and security enthusiasts to learn about Android insecurities.
* [DIVA Android](https://github.com/payatu/diva-android) ⭐ 1,134 | 🐛 13 | 🌐 Java | 📅 2023-05-19 - Damn Insecure and vulnerable App for Android.
...
* [AndroGoat](https://github.com/satishpatnayak/AndroGoat) ⭐ 387 | 🐛 2 | 🌐 Kotlin | 📅 2025-11-22 - AndroGoat is purposely developed open source vulnerable/insecure app using Kotlin.
...
* [Owasp Juice shop](https://github.com/juice-shop/juice-shop) ⭐ 13,669 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-10 - OWASP Juice Shop: Probably the most modern and sophisticated insecure web application
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,495 | 🐛 7 | 🌐 PHP | 📅 2026-08-07 - Damn Vulnerable Web Application (DVWA)
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,276 | 🐛 37 | 🌐 JavaScript | 📅 2026-08-14 - WebGoat is a deliberately insecure application by OWASP for training purpose
...
* [OWASP Mutillidae II](https://github.com/webpwnized/mutillidae) ⭐ 1,510 | 🐛 1 | 🌐 PHP | 📅 2026-06-22 - OWASP Mutillidae II is a free, open source, deliberately vulnerable web-application providing a target for web-security enthusiast.
* [VAmPI](https://github.com/erev0s/VAmPI) ⭐ 1,278 | 🐛 4 | 🌐 Python | 📅 2026-04-07 - Vulnerable REST API with OWASP top 10 vulnerabilities for security testing
...
* [Owasp VulnerableApp](https://github.com/SasanLabs/VulnerableApp) ⭐ 450 | 🐛 94 | 🌐 Java | 📅 2026-08-14 - A modular deliberately vulnerable application designed primarily for validating and benchmarking security scanners through reproducible test scenarios, while also supporting learning and experimentation.
...
* [OSS – OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 34 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-13 - An intentionally vulnerable e-commerce application built with Next.js and React. A self-hosted CTF platform for web security training covering OWASP Top 10 vulnerabilities.
...
* [CORS-vulnerable-Lab](https://github.com/incredibleindishell/CORS-vulnerable-Lab) ⭐ 190 | 🐛 3 | 🌐 PHP | 📅 2021-03-14 - Sample vulnerable code and its exploit code
...
* [The Most Vulnerable .NET App](https://github.com/AlexGoOn/the-most-vulnerable-dotnet-app) ⭐ 491 | 🐛 0 | 🌐 HTML | 📅 2026-03-06 - Interactive educational project that demonstrates common security vulnerabilities in .NET applications

### Node.js

* [DVNA](https://github.com/appsecco/dvna) ⭐ 778 | 🐛 16 | 🌐 SCSS | 📅 2024-03-27 - Damn Vulnerable NodeJS Application
* [dvws-node](https://github.com/snoopysecurity/dvws-node) ⭐ 514 | 🐛 4 | 🌐 JavaScript | 📅 2026-03-29 - Damn Vulnerable Web Service is a vulnerable web service/API/application that can be used to learn webservices/API vulnerabilities.
...
* [Vulhub](https://github.com/vulhub/vulhub) ⭐ 21,118 | 🐛 50 | 🌐 Dockerfile | 📅 2026-07-22 - Vulhub is an open-source collection of pre-built vulnerable docker environments.
...
* [VulnerableLightApp](https://github.com/Aif4thah/VulnerableLightApp) ⭐ 60 | 🐛 0 | 🌐 C# | 📅 2026-02-25 - .NET vulnerable REST API
