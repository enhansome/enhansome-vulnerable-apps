...
* [InsecureBankv2](https://github.com/dineshshetty/Android-InsecureBankv2) ⭐ 1,471 | 🐛 17 | 🌐 Java | 📅 2024-04-17 - Vulnerable Android application for developers and security enthusiasts to learn about Android insecurities.
* [DIVA Android](https://github.com/payatu/diva-android) ⭐ 1,140 | 🐛 13 | 🌐 Java | 📅 2023-05-19 - Damn Insecure and vulnerable App for Android.
...
* [Owasp Juice shop](https://github.com/juice-shop/juice-shop) ⭐ 13,733 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-24 - OWASP Juice Shop: Probably the most modern and sophisticated insecure web application
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,557 | 🐛 7 | 🌐 PHP | 📅 2026-08-19 - Damn Vulnerable Web Application (DVWA)
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,300 | 🐛 39 | 🌐 JavaScript | 📅 2026-08-24 - WebGoat is a deliberately insecure application by OWASP for training purpose
...
* [Owasp VulnerableApp](https://github.com/SasanLabs/VulnerableApp) ⭐ 459 | 🐛 111 | 🌐 Java | 📅 2026-08-28 - A modular deliberately vulnerable application designed primarily for validating and benchmarking security scanners through reproducible test scenarios, while also supporting learning and experimentation.
...
* [OWASP IoT Goat](https://github.com/OWASP/IoTGoat) ⭐ 922 | 🐛 2 | 🌐 C | 📅 2025-10-05 - IoTGoat is a deliberately insecure firmware created to educate software developers and security professionals with testing commonly found vulnerabilities in IoT devices.
...
* [Vulhub](https://github.com/vulhub/vulhub) ⭐ 21,175 | 🐛 52 | 🌐 Dockerfile | 📅 2026-07-22 - Vulhub is an open-source collection of pre-built vulnerable docker environments.
