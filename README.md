...
* [Vulhub](https://github.com/vulhub/vulhub) ⭐ 21,221 | 🐛 53 | 🌐 Dockerfile | 📅 2026-07-22
* [Metasploitable3](https://github.com/rapid7/metasploitable3) ⭐ 5,696 | 🐛 75 | 🌐 HTML | 📅 2025-02-13 - Metasploitable3 is a VM that is built from the ground up with a large amount of security vulnerabilities.
...
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,721 | 🐛 24 | 🌐 Python | 📅 2026-04-28 - CloudGoat is Rhino Security Labs' "Vulnerable by Design" AWS deployment tool
...
* [Unguard](https://github.com/dynatrace-oss/unguard) ⭐ 75 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-07 - An insecure cloud-native microservices demo application for Kubernetes
...
* [OVAA](https://github.com/oversecured/ovaa) ⭐ 756 | 🐛 1 | 🌐 Java | 📅 2024-07-18 - Oversecured Vulnerable Android App.
* [Allsafe](https://github.com/t0thkr1s/allsafe) ⭐ 423 | 🐛 2 | 🌐 Java | 📅 2025-09-20 - Allsafe is an intentionally vulnerable application that contains various vulnerabilities.
* [AndroGoat](https://github.com/satishpatnayak/AndroGoat) ⭐ 393 | 🐛 2 | 🌐 Kotlin | 📅 2025-11-22 - AndroGoat is purposely developed open source vulnerable/insecure app using Kotlin.
...
* [Owasp Juice shop](https://github.com/juice-shop/juice-shop) ⭐ 13,807 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-07 - OWASP Juice Shop: Probably the most modern and sophisticated insecure web application
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,625 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - Damn Vulnerable Web Application (DVWA)
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,323 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-07 - WebGoat is a deliberately insecure application by OWASP for training purpose
...
* [crApi](https://github.com/OWASP/crAPI) ⭐ 1,571 | 🐛 31 | 🌐 Java | 📅 2026-05-14 - completely ridiculous API: crAPI will help you to understand the ten most critical API security risks. crAPI is vulnerable by design, but you'll be able to safely run it to educate/train yourself.
...
* [VAmPI](https://github.com/erev0s/VAmPI) ⭐ 1,316 | 🐛 4 | 🌐 Python | 📅 2026-04-07 - Vulnerable REST API with OWASP top 10 vulnerabilities for security testing
...
* [Owasp VulnerableApp](https://github.com/SasanLabs/VulnerableApp) ⭐ 461 | 🐛 109 | 🌐 Java | 📅 2026-09-08 - A modular deliberately vulnerable application designed primarily for validating and benchmarking security scanners through reproducible test scenarios, while also supporting learning and experimentation.
...
* [OSS – OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 42 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-06 - An intentionally vulnerable e-commerce application built with Next.js and React. A self-hosted CTF platform for web security training covering OWASP Top 10 vulnerabilities.
...
* [Vulhub](https://github.com/vulhub/vulhub) ⭐ 21,221 | 🐛 53 | 🌐 Dockerfile | 📅 2026-07-22 - Vulhub is an open-source collection of pre-built vulnerable docker environments.
