...
* [Vulhub](https://github.com/vulhub/vulhub) ⭐ 21,259 | 🐛 53 | 🌐 Dockerfile | 📅 2026-09-18
* [Metasploitable3](https://github.com/rapid7/metasploitable3) ⭐ 5,711 | 🐛 74 | 🌐 HTML | 📅 2025-02-13 - Metasploitable3 is a VM that is built from the ground up with a large amount of security vulnerabilities.
...
* [Owasp Juice shop](https://github.com/juice-shop/juice-shop) ⭐ 13,912 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-21 - OWASP Juice Shop: Probably the most modern and sophisticated insecure web application
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,701 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - Damn Vulnerable Web Application (DVWA)
* [WebGoat](https://github.com/WebGoat/WebGoat) ⭐ 9,344 | 🐛 41 | 🌐 JavaScript | 📅 2026-09-21 - WebGoat is a deliberately insecure application by OWASP for training purpose
...
* [crApi](https://github.com/OWASP/crAPI) ⭐ 1,590 | 🐛 30 | 🌐 Java | 📅 2026-09-09 - completely ridiculous API: crAPI will help you to understand the ten most critical API security risks. crAPI is vulnerable by design, but you'll be able to safely run it to educate/train yourself.
...
* [Owasp VulnerableApp](https://github.com/SasanLabs/VulnerableApp) ⭐ 463 | 🐛 107 | 🌐 Java | 📅 2026-09-21 - A modular deliberately vulnerable application designed primarily for validating and benchmarking security scanners through reproducible test scenarios, while also supporting learning and experimentation.
...
* [Vulhub](https://github.com/vulhub/vulhub) ⭐ 21,259 | 🐛 53 | 🌐 Dockerfile | 📅 2026-09-18 - Vulhub is an open-source collection of pre-built vulnerable docker environments.
